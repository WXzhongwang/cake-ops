package com.rany.acl.service.remote.tenant;
...
import com.rany.acl.api.command.tenant.*;
import com.rany.acl.api.facade.tenant.TenantFacade;
import com.rany.acl.api.query.tenant.TenantBasicQuery;
import com.rany.acl.api.query.tenant.TenantPageQuery;
import com.rany.acl.api.query.tenant.TenantQuery;
...
import com.rany.acl.service.aop.annotation.IsvValidCheck;
